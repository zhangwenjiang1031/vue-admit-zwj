...
<el-table :data="product"><!--为是啥用：data？答：详情element，表格-->
    ...
    <el-table-column fixed="left" prop="description" label="姓名"></el-table-column>
    <el-table-column prop="price" label="价格"></el-table-column>
    <el-table-column width="120" prop="photo" label="号码"></el-table-column>
    <el-table-column width="200" prop="categoryId" label="ID"></el-table-column> 
